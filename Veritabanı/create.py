...
cursor.execute(sorgu_8, (0,'COM6',9600,'Parity.none',2,'Stopbits.one',219,2,3,'Float'))
cursor.execute(sorgu_8, (1,'COM6',9600,'Parity.none',2,'Stopbits.one',227,2,3,'Float'))
cursor.execute(sorgu_8, (2,'COM6',9600,'Parity.none',2,'Stopbits.one',225,2,3,'Float'))
cursor.execute(sorgu_8, (4,'COM6',9600,'Parity.none',2,'Stopbits.one',229,2,3,'Float'))
cursor.execute(sorgu_8, (6,'COM6',9600,'Parity.none',1,'Stopbits.one',0,2,3,'Float'))
cursor.execute(sorgu_8, (7,'COM6',9600,'Parity.none',2,'Stopbits.one',223,2,3,'Float'))
